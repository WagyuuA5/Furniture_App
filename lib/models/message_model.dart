    ...
    final Map<String, List<MessageModel>> data = {
      'chat_1': [
        ...
        MessageModel(
          id: 'm2',
          senderId: me,
          content: 'Hai, ada yang bisa dibantu?',
          type: MessageType.text,
        ...
        MessageModel(
          id: 'm3',
          senderId: 'u1',
          content: 'Apakah sofa model Nordic masih ada?',
          type: MessageType.text,
        ...
        MessageModel(
          id: 'm4',
          senderId: me,
          content: 'Masih ada kak, mau warna apa?',
          type: MessageType.text,
        ...
        MessageModel(
          id: 'm5',
          senderId: 'u1',
          content: 'Warna abu-abu ya. Berapa harganya?',
          type: MessageType.text,
        ...
        MessageModel(
          id: 'm6',
          senderId: me,
          content: 'Rp 2.500.000 kak, sudah termasuk ongkos pasang',
          type: MessageType.text,
        ...
        MessageModel(
          id: 'm7',
          senderId: 'u1',
          content: 'Oke saya mau pesan 1 ya!',
          type: MessageType.text,
      ...
      'chat_2': [
        MessageModel(
          id: 'm1',
          senderId: me,
          content: 'Selamat pagi kak Sheila!',
          type: MessageType.text,
        ...
        MessageModel(
          id: 'm2',
          senderId: 'u2',
          content: 'Pagi! Ada promo hari ini?',
          type: MessageType.text,
        ...
        MessageModel(
          id: 'm3',
          senderId: me,
          content: 'Ada diskon 20% untuk semua kursi kak',
          type: MessageType.text,
        ...
        MessageModel(
          id: 'm4',
          senderId: 'u2',
          content: 'Oke, saya tunggu konfirmasinya ya',
          type: MessageType.text,
          timestamp: now.subtract(const Duration(minutes: 15)),
        ),
      ],
      'chat_3': [
        MessageModel(
          id: 'm1',
          senderId: 'u3',
          content: 'Pesanan sudah sampai kak!',
          type: MessageType.text,
        ...
        MessageModel(
          id: 'm2',
          senderId: me,
          content: 'Alhamdulillah, terima kasih sudah berbelanja',
          type: MessageType.text,
          timestamp: now.subtract(const Duration(hours: 2)),
        ),
        MessageModel(
          id: 'm3',
          senderId: 'u3',
          content: 'Terima kasih sudah memesan!',
          type: MessageType.text,
