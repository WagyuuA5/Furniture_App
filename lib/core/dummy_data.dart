...
class AppData {
  ...
  static final List<Product> flashSaleProducts = [
    Product(
      ...
      oldPrice: 3200000.0,
      stock: 10,
      description: 'Sofa minimalis dengan balutan kain kanvas berkualitas tinggi. Cocok untuk ruang tamu kecil maupun besar. Busa tebal dan tidak mudah kempes.',
    ...
    Product(
      ...
      imageUrl: 'https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e?w=600&auto=format&fit=crop',
      rating: 4.9,
      sold: 50,
      thumbnails: ['https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e?w=600&auto=format&fit=crop'],
    ),
    Product(
      id: 3,
      ...
      rating: 4.5,
      sold: 110,
      thumbnails: ['https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=600&auto=format&fit=crop'],
    ),
    Product(
      id: 4,
      ...
      oldPrice: 850000.0,
      stock: 12,
      description: 'Modern Accent Chair hadir dengan desain minimalis-modern yang memberikan kesan elegan. Sofa ini cocok digunakan untuk ruang tamu, bedroom, maupun sudut santai di rumah.',
